"""
This module contains a class, ExploratoryAnalysis, designed for performing exploratory data analysis (EDA) on a given dataset.

Class:
    - ExploratoryAnalysis: A class for performing exploratory data analysis.    
"""
...
class ExploratoryAnalysis:
    ...
    Methods:
    - __init__(self, data): Initializes the ExploratoryAnalysis class.
    - all_total_students(self): Calculate and return the total number of students enrolled across all schools.
    - matplot_hist_total_students(self): Generate and display a histogram of the total number of students using Matplotlib.
    - seaborn_hist_total_students(self): Generate and display a histogram of the total number of students using Seaborn.
    - population_borough(self): Calculate and return the percentage population of each borough.
    - matplot_bar_borough(self): Generate and display a barplot indicating the population of each borough using Matplotlib.
    - seaborn_bar_borough(self): Generate and display a barplot indicating the population of each borough using Seaborn.
    - matplot_bar_grpby_borough_tot_students(self): Generate and display a bar plot showing the distribution of students enrolled in each borough using Matplotlib.
    - seaborn_bar_borough_tot_students(self): Generate and display a barplot showing the distribution of students enrolled in each borough using Seaborn.
    - unique_activities(self): Calculate and return the number of unique Extracurricular Activities provided by all schools.
    - activities_desc(self): Describe the field 'num_ext_act' representing the number of extracurricular activities.
    - matplot_scatter_tot_studs_vs_activities(self): Generate and display a scatter plot of total_students vs the number of extracurricular activities offered using Matplotlib.
    - seaborn_scatter_tot_studs_vs_activities(self): Generate and display a scatter plot of total_students vs the number of extracurricular activities offered using Seaborn.
    - num_prtn(self): Calculate and store the number of partner-related metrics for analysis.
    - matplot_scatter_students_vs_partners(self): Generate and display a scatter plot of total_students vs the number of partner opportunities using Matplotlib.
    - seaborn_scatter_students_vs_partners(self): Generate and display a scatter plot of total_students vs the number of partner opportunities using Seaborn.
